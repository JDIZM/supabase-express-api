...
export function routes(app: Application): void {
  ...
  app.put(
    API_ROUTES.workspaceMemberRole,
    isAuthenticated,
    checkAccountStatus,
    isAuthorized,
    updateMemberRole
  ...
  app.delete(
    API_ROUTES.workspaceMemberRemove,
    isAuthenticated,
    checkAccountStatus,
    isAuthorized,
    removeMember
