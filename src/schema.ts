...
export const profiles = pgTable(
  ...
  (table) => ({
    uniqueAccountWorkspace: unique("unique_account_workspace").on(
      table.accountId,
      table.workspaceId
    ),
    ...
    workspaceAccountIdx: index("profiles_workspace_account_idx").on(
      table.workspaceId,
      table.accountId
    ),
  })
...
export const workspaceMemberships = pgTable(
  ...
  (table) => ({
    uniqueMembershipPerWorkspace: unique("unique_membership_per_workspace").on(
      table.accountId,
      table.workspaceId
    ),
