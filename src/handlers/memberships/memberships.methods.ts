...
export async function createMembership(
  ...
  logger.info(
    `Creating membership for account: ${accountId} in workspace: ${workspaceId} as role: ${role}`
  )
  ...
  logger.info({
    msg: `Created membership for account: ${accountId} in workspace: ${workspaceId} as role: ${role}`,
  })
